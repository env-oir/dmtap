...
| Signature DS-tags (§18.9 convention) | `DMTAP-SYNC-v0/op`, `DMTAP-SYNC-v0/snapshot` — reserved identifiers, distinct from every `DMTAP-v0/…` and `DMTAP-PUB-v0/…` DS-tag already registered. |
