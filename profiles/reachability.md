...
| **Signalling** role | the reachability *ladder* — direct (rung 1) → hole-punch (rung 2) → adapter tunnel (rung 3). REACH is the rung-3 fallback for clients that cannot mesh. | [ROLES §3](../substrate/ROLES.md) |
