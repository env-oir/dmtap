...
- **`conformance/SUITE.md`** — the normative test-case catalogue: 361 numbered cases
...
- **`conformance/suite.json`** — the machine-readable mirror of those cases, so a runner in **any
  language** can drive them. It mirrors all 361 (SUITE.md and suite.json are in sync — the wave-2
...
58 + 19 + 284 = 361. An implementation conforms at a level iff it passes every `MUST` case of that
...
cases that **pass** (58 of 361 are byte-runnable today, and no implementation has yet been run
