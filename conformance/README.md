...
`SUITE.md` catalogues **361** numbered cases and `suite.json` mirrors all **361** — the two are **in
...
partition is exact: 52 + 6 + 284 + 19 = 361.
...
2. It counts cases that **exist**, not cases that **pass.** 58 of 361 are byte-runnable today and
