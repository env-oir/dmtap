...
`SUITE.md` catalogs **344** numbered cases and `suite.json` mirrors all **344** — the two are **in
...
self-contained CBOR-reject cases whose bytes are inline); 264 are `construction-todo` — each
...
partition is exact: 56 + 6 + 264 + 18 = 344.
